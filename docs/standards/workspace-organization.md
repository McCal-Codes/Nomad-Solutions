...
## 7. Widget Assets Organization

- Built, embeddable widget bundles live under `public/widgets/<widget-name>/<version>/`.
	- Examples:
		- `public/widgets/availability/v1.0.0/availability-widget-simple.js`
		- `public/widgets/fleet/v1.0.0/fleet-widget-simple.js`
- Keep legacy top-level bundles (e.g., `public/widgets/availability-widget-simple.js`) for backward compatibility and CI size checks.
- Public demos are versioned under `public/demos/<widget-name>/<version>.html` with a central index at `public/demos/index.html`.
- When releasing a new version:
	1. Copy the prior bundle to the new version folder and update as needed.
	2. Add a new version card or enable the version dropdown to point to the new file.
	3. Update the widget README in `public/demos/<widget-name>/README.md` with changelog and upgrade notes.

...
Guidelines, conventions, and best practices for the Nomad Solutions repository (widgets + Next.js app).
...
*These standards ensure consistency, maintainability, and quality across all Nomad Solutions widgets and assets.*